...
namespace SportsStore.Tests
{
    public class ProductControllerTests
    {
        ...
        public void Generate_Category_Specific_Product_Count()
        {
            ...
            // Action
            var result1 = getModel(target.List("Cat1"))?.PagingInfo.TotalItems;
            var result2 = getModel(target.List("Cat2"))?.PagingInfo.TotalItems;
            var result3 = getModel(target.List("Cat3"))?.PagingInfo.TotalItems;
            var resultAll = getModel(target.List(null))?.PagingInfo.TotalItems;
